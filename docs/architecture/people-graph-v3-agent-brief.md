# Original brief and shared contract for the v3 schema lane

**Source:** user-provided `Pasted text.txt`  
**Source SHA-256:** `077e5096298b776b5df33aba7ac8fa159296b3671c570a92a64ad74ebe53674d`  
**Relevant section:** `Prompt 3 — Additive People Graph v3 ontology and schema`  
**Recorded:** 2026-08-06

This file preserves the exact shared operating rules and the exact lane brief that
constrained this proposal. It is committed so another agent can reproduce the
scope without relying on chat history. Prompts for unrelated lanes are omitted;
no omitted lane text was used to design this schema.

## Shared operating rules and observation contract — verbatim
